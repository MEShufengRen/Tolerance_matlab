function pop= Duanke_test(Part_sort,generation,part_distribute,Index_Geometry)
...
%% 读取节点坐标信息和刚度矩阵
K_Path_tol='C:\Users\Shufeng Ren\Desktop\V2_td_Test\K_Information\Duanke_K'; %输入储存刚度阵文件的位置
Node_Path_tol='C:\Users\Shufeng Ren\Desktop\V2_td_Test\K_Information\Duanke_Node'; %输入储存节点坐标编号文件的位置
