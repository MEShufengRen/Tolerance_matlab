function pop= Xiangdi_test(Part_sort,generation,part_distribute,Index_Geometry)
% Part_sort表示零件种类  range正态分布模拟偏差场的范围 generation 种群迭代次数
% Index_Geometry是几何指标，要求输入[上下平面度，平行度，上下圆度，轮廓度]共6个指标
...
%% 读取节点坐标信息和刚度矩阵
K_Path_tol='C:\Users\Shufeng Ren\Desktop\V2_td_Test\K_Information\Xiangdi_K'; %输入储存刚度阵文件的位置
Node_Path_tol='C:\Users\Shufeng Ren\Desktop\V2_td_Test\K_Information\Xiangdi_Node'; %输入储存节点坐标编号文件的位置
